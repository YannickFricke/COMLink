...
import { AddContact, DeleteContact, EditContact } from '../store/ducks/contact.duck';
import { AddMessage, DeleteMessage, EditMessage, SetFilteredIds } from '../store/ducks/message.duck';
    ...
    useEffect(() => {
        ...
        createdSocket.on('connect', () => {
            ...
            createdSocket.on(
                ...
                ([filteredIds]: [string[]]) => {
                    dispatch(SetFilteredIds(filteredIds));
                },
            );
        });
